                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="strip_list">
                            ...
                            <a data-toggle="tooltip" data-placement="top" data-original-title="Badge Level" className="badge_list_1"><img src="img/badges/badge_1.svg" width="15" height="15" alt=""/></a>
                            <ul>
                                <li><a href="#0" onClick={() => {}} className="btn_listing">View on Map</a></li>
